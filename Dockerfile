...
RUN apt-get update && apt-get install -y wget unzip gnupg curl xvfb fonts-liberation libasound2 \
...
# Install matching ChromeDriver (using chromedriver.storage.googleapis.com mirror)
